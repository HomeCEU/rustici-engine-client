...
class MediaFileMetadataSchema implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $content_language Language code that specifies the content's language. For media file content, the default value is 'en'.
     *
     * @return $this
     */
     ...
     * Sets move_on
     *
     * @param string $move_on Value of the cmi5 'moveOn' property for the referenced course content. For media file content, the default value is 'Completed'. This property is only applicable with the following learning standards: cmi5, MediaFile.
     *
     * @return $this
     */
