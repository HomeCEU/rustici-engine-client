...
class RegistrationApi
{
     ...
     * @return \Swagger\Client\Model\LaunchLinkSchema
     */
    public function createRegistrationWithLaunchLink($engine_tenant_name, $create_request)
    {
        list($response) = $this->createRegistrationWithLaunchLinkWithHttpInfo($engine_tenant_name, $create_request);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\LaunchLinkSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRegistrationWithLaunchLinkWithHttpInfo($engine_tenant_name, $create_request)
    {
        $returnType = '\Swagger\Client\Model\LaunchLinkSchema';
        $request = $this->createRegistrationWithLaunchLinkRequest($engine_tenant_name, $create_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRegistrationWithLaunchLinkAsync($engine_tenant_name, $create_request)
    {
        return $this->createRegistrationWithLaunchLinkAsyncWithHttpInfo($engine_tenant_name, $create_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRegistrationWithLaunchLinkAsyncWithHttpInfo($engine_tenant_name, $create_request)
    {
        $returnType = '\Swagger\Client\Model\LaunchLinkSchema';
        $request = $this->createRegistrationWithLaunchLinkRequest($engine_tenant_name, $create_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRegistrationWithLaunchLinkRequest($engine_tenant_name, $create_request)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
