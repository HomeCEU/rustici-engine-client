...
class AppManagementApi
{
     ...
     * Create credential
     *
     * @param  \Swagger\Client\Model\CredentialRequestSchema $body body (required)
     ...
     */
    public function createCredential($body, $engine_tenant_name = null)
    {
        list($response) = $this->createCredentialWithHttpInfo($body, $engine_tenant_name);
        return $response;
    }
     ...
     * Create credential
     *
     * @param  \Swagger\Client\Model\CredentialRequestSchema $body (required)
     * @param  string $engine_tenant_name If specified, the tenant that will be used to store or validate the credentials or token. If not specified, the system data store / settings will be used. Note that PermissionsSchema contains &#x27;tenantName&#x27; which should be used for any permissions that need to be scoped to a particular tenant. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createCredentialWithHttpInfo($body, $engine_tenant_name = null)
    {
        $returnType = '\Swagger\Client\Model\CredentialCreatedSchema';
        $request = $this->createCredentialRequest($body, $engine_tenant_name);
     ...
     */
    public function createCredentialAsync($body, $engine_tenant_name = null)
    {
        return $this->createCredentialAsyncWithHttpInfo($body, $engine_tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCredentialAsyncWithHttpInfo($body, $engine_tenant_name = null)
    {
        $returnType = '\Swagger\Client\Model\CredentialCreatedSchema';
        $request = $this->createCredentialRequest($body, $engine_tenant_name);
     ...
     */
    protected function createCredentialRequest($body, $engine_tenant_name = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createCredential'
            );
        }
     ...
     * @return void
     */
    public function createOrUpdateTenant($body, $tenant_name)
    {
        $this->createOrUpdateTenantWithHttpInfo($body, $tenant_name);
    }
     ...
     */
    public function createOrUpdateTenantWithHttpInfo($body, $tenant_name)
    {
        $returnType = '';
        $request = $this->createOrUpdateTenantRequest($body, $tenant_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrUpdateTenantAsync($body, $tenant_name)
    {
        return $this->createOrUpdateTenantAsyncWithHttpInfo($body, $tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrUpdateTenantAsyncWithHttpInfo($body, $tenant_name)
    {
        $returnType = '';
        $request = $this->createOrUpdateTenantRequest($body, $tenant_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createOrUpdateTenantRequest($body, $tenant_name)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createOrUpdateTenant'
            );
        }
     ...
     * Create token
     *
     * @param  \Swagger\Client\Model\TokenRequestSchema $body body (required)
     * @param  string $engine_tenant_name If specified, the tenant that will be used to store or validate the credentials or token. If not specified, the system data store / settings will be used. Note that PermissionsSchema contains &#x27;tenantName&#x27; which should be used for any permissions that need to be scoped to a particular tenant. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createToken($body, $engine_tenant_name = null)
    {
        list($response) = $this->createTokenWithHttpInfo($body, $engine_tenant_name);
        return $response;
    }
     ...
     * Create token
     *
     * @param  \Swagger\Client\Model\TokenRequestSchema $body (required)
     * @param  string $engine_tenant_name If specified, the tenant that will be used to store or validate the credentials or token. If not specified, the system data store / settings will be used. Note that PermissionsSchema contains &#x27;tenantName&#x27; which should be used for any permissions that need to be scoped to a particular tenant. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createTokenWithHttpInfo($body, $engine_tenant_name = null)
    {
        $returnType = '\Swagger\Client\Model\StringResultSchema';
        $request = $this->createTokenRequest($body, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTokenAsync($body, $engine_tenant_name = null)
    {
        return $this->createTokenAsyncWithHttpInfo($body, $engine_tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTokenAsyncWithHttpInfo($body, $engine_tenant_name = null)
    {
        $returnType = '\Swagger\Client\Model\StringResultSchema';
        $request = $this->createTokenRequest($body, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createTokenRequest($body, $engine_tenant_name = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getApplicationConfiguration($engine_tenant_name = null, $learning_standard = null, $single_sco = null, $include_metadata = null, $include_hidden_settings = null, $include_secret_settings = null, $process_replacement_tokens = null)
    {
     ...
     */
    public function getApplicationConfigurationWithHttpInfo($engine_tenant_name = null, $learning_standard = null, $single_sco = null, $include_metadata = null, $include_hidden_settings = null, $include_secret_settings = null, $process_replacement_tokens = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApplicationConfigurationAsync($engine_tenant_name = null, $learning_standard = null, $single_sco = null, $include_metadata = null, $include_hidden_settings = null, $include_secret_settings = null, $process_replacement_tokens = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApplicationConfigurationAsyncWithHttpInfo($engine_tenant_name = null, $learning_standard = null, $single_sco = null, $include_metadata = null, $include_hidden_settings = null, $include_secret_settings = null, $process_replacement_tokens = null)
    {
        $returnType = '\Swagger\Client\Model\SettingListSchema';
        $request = $this->getApplicationConfigurationRequest($engine_tenant_name, $learning_standard, $single_sco, $include_metadata, $include_hidden_settings, $include_secret_settings, $process_replacement_tokens);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApplicationConfigurationRequest($engine_tenant_name = null, $learning_standard = null, $single_sco = null, $include_metadata = null, $include_hidden_settings = null, $include_secret_settings = null, $process_replacement_tokens = null)
    {
     ...
     *
     * @param  bool $include_deactivated include_deactivated (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\TenantListSchema
     */
    public function getTenantList($include_deactivated = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantListAsync($include_deactivated = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantListAsyncWithHttpInfo($include_deactivated = null)
    {
        $returnType = '\Swagger\Client\Model\TenantListSchema';
        $request = $this->getTenantListRequest($include_deactivated);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTenantListRequest($include_deactivated = null)
    {
     ...
     *
     * @param  \Swagger\Client\Model\PIIDeletionRequestSchema $body body (required)
     * @param  string $engine_tenant_name tenant for this request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postPIIDeletionJob($body, $engine_tenant_name)
    {
        list($response) = $this->postPIIDeletionJobWithHttpInfo($body, $engine_tenant_name);
        return $response;
    }
     ...
     * Initiate a job to delete a user's Personal Identifying Information from the system.
     *
     * @param  \Swagger\Client\Model\PIIDeletionRequestSchema $body (required)
     * @param  string $engine_tenant_name tenant for this request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postPIIDeletionJobWithHttpInfo($body, $engine_tenant_name)
    {
        $returnType = '\Swagger\Client\Model\PIIDeletionRequestResultSchema';
        $request = $this->postPIIDeletionJobRequest($body, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPIIDeletionJobAsync($body, $engine_tenant_name)
    {
        return $this->postPIIDeletionJobAsyncWithHttpInfo($body, $engine_tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPIIDeletionJobAsyncWithHttpInfo($body, $engine_tenant_name)
    {
        $returnType = '\Swagger\Client\Model\PIIDeletionRequestResultSchema';
        $request = $this->postPIIDeletionJobRequest($body, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPIIDeletionJobRequest($body, $engine_tenant_name)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPIIDeletionJob'
            );
        }
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
     ...
     * @return void
     */
    public function setApplicationConfiguration($body, $engine_tenant_name = null, $learning_standard = null, $single_sco = null)
    {
        $this->setApplicationConfigurationWithHttpInfo($body, $engine_tenant_name, $learning_standard, $single_sco);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setApplicationConfigurationWithHttpInfo($body, $engine_tenant_name = null, $learning_standard = null, $single_sco = null)
    {
        $returnType = '';
        $request = $this->setApplicationConfigurationRequest($body, $engine_tenant_name, $learning_standard, $single_sco);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setApplicationConfigurationAsync($body, $engine_tenant_name = null, $learning_standard = null, $single_sco = null)
    {
        return $this->setApplicationConfigurationAsyncWithHttpInfo($body, $engine_tenant_name, $learning_standard, $single_sco)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setApplicationConfigurationAsyncWithHttpInfo($body, $engine_tenant_name = null, $learning_standard = null, $single_sco = null)
    {
        $returnType = '';
        $request = $this->setApplicationConfigurationRequest($body, $engine_tenant_name, $learning_standard, $single_sco);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setApplicationConfigurationRequest($body, $engine_tenant_name = null, $learning_standard = null, $single_sco = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling setApplicationConfiguration'
            );
        }
     ...
     * @return void
     */
    public function updateCredential($body, $credential_id, $engine_tenant_name = null)
    {
        $this->updateCredentialWithHttpInfo($body, $credential_id, $engine_tenant_name);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCredentialWithHttpInfo($body, $credential_id, $engine_tenant_name = null)
    {
        $returnType = '';
        $request = $this->updateCredentialRequest($body, $credential_id, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCredentialAsync($body, $credential_id, $engine_tenant_name = null)
    {
        return $this->updateCredentialAsyncWithHttpInfo($body, $credential_id, $engine_tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCredentialAsyncWithHttpInfo($body, $credential_id, $engine_tenant_name = null)
    {
        $returnType = '';
        $request = $this->updateCredentialRequest($body, $credential_id, $engine_tenant_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCredentialRequest($body, $credential_id, $engine_tenant_name = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateCredential'
            );
        }
        // verify the required parameter 'credential_id' is set
        if ($credential_id === null || (is_array($credential_id) && count($credential_id) === 0)) {
